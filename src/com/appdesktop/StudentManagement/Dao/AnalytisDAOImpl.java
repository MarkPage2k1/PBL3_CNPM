...
public class AnalytisDAOImpl implements AnalytisDAO {
    ...
    public List<ClassBean> getListByClass() {
        ...
        String sql = "SELECT registerdate, COUNT(*) AS numberOfStudents FROM student_management.class_student GROUP BY registerdate order by registerdate ASC;";
    ...
    public List<CourseBean> getListByCourse() {
        ...
        String sql = "SELECT coursename, startdate, enddate FROM student_management.course WHERE status = TRUE ORDER BY enddate ASC;";
