...
import static com.appdesktop.StudentManagement.view.StudentDetailJDialog.valiDateEmpty;

/**
 *
 * @author Mark
 */
public class FormDetailJDialog extends javax.swing.JDialog {

    private MainJFrame parentForm;
    private ClassController classController = null;
   
    //StudentController controller = null;
    String id = FormManagerJPanel.idForForm;
    byte statusShowForm = FormManagerJPanel.statusShowForm;
  
    final byte Detail = 0;
    final byte Add = 1;
    final byte Edit = 2;
    
    public FormDetailJDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(parent);
        classController = new ClassController(id, jtfID, jtfName, jcheckStatus, jComboBox1, 
                jDateStartOrReg, jDateEnd, jTextNote);
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(jlbEndDate, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(10, 10, 10)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormDetailJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormDetailJDialog dialog = new FormDetailJDialog(new javax.swing.JFrame(), true);
