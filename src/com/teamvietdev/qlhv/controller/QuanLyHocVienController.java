...
public class QuanLyHocVienController 
{
    ...
    public QuanLyHocVienController(JPanel jpnView, JButton btAdd, JTextField jtfSearch) 
    {
    ...
    public void setDateToTable()
    {
        ...
        table.getTableHeader().setFont(new Font("Arrial", Font.BOLD, 18));
    ...
    public void setEvent()
    {
        ...
        {
            btAdd.setBackground(new Color(0, 200, 83));
        }
        
        @Override
        public void mouseExited(MouseEvent e)
        {
            btAdd.setBackground(new Color(100, 221, 23));
        }
        });
    }
}
