...
public class HocVienJPanel extends javax.swing.JPanel {
    ...
    public HocVienJPanel() {
        initComponents();
        QuanLyHocVienController controller = new QuanLyHocVienController(jpnView, btAdd, jtfSearch); 
    ...
    private void initComponents() {
        ...
        btAdd.setBackground(new java.awt.Color(255, 153, 51));
        btAdd.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        btAdd.setText("Thêm mới");
        btAdd.setBorder(null);

        jtfSearch.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
