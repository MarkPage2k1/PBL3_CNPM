...
import com.appdesktop.StudentManagement.Controller.StudentController;
...
public class StudentDetailJDialog extends javax.swing.JDialog {

    private MainJFrame parentForm;
    private byte[] personalImage;
    
    StudentController controller = null;
    String id = StudentManagementJPanel.idStudent;
    Boolean statusEdit = StudentManagementJPanel.statusEdit;

    public StudentDetailJDialog(java.awt.Frame parent, boolean modal) throws Exception {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(parent);
        this.controller = new StudentController(id, jtfIdStudent, jtfName, jBrithday, jrbtnMale, 
                jrbtnFemale, jCheckBox, jAddress, jtfEmail, jtfPhone, jlbAvatar, statusEdit, personalImage);
        if (statusEdit == true){
            this.jtfIdStudent.setText(id);
            jtfIdStudent.setEnabled(false);
            controller.LoadInforStudent();
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Thông tin sinh viên chi tiết");
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        boolean flag = controller.updateInforStudent(personalImage);
        
        if (flag) {
                MessageDialogHelper.showMessageDialog(parentForm, "Thông tin sinh viên đã được lưu", "Thông báo");
                btnCancelActionPerformed(evt);
        } else {
            MessageDialogHelper.showConfirmDialog(parentForm, "Thông tin sinh viên không được lưu", "Thông báo");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StudentDetailJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                StudentDetailJDialog dialog = null;
                try {
                    dialog = new StudentDetailJDialog(new javax.swing.JFrame(), true);
                } catch (Exception ex) {
                    Logger.getLogger(StudentDetailJDialog.class.getName()).log(Level.SEVERE, null, ex);
                }
