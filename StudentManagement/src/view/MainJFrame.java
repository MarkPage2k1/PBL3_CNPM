...
public class MainJFrame extends javax.swing.JFrame {
    ...
    private FormDetailClass formdetailclass;
...
//        setLocationRelativeTo(null); 
    ...
    private void initComponents() {
        ...
        btnMenuProfile.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/linux.png"))); // NOI18N
        ...
        btn1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/graduated32.png"))); // NOI18N
        btn1.setText("Quản lí sinh viên");
        ...
        btn2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/teacher32.png"))); // NOI18N
        btn2.setText("Quản lí giảng viên");
        ...
        btn3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/course32.png"))); // NOI18N
        btn3.setText("Quản lí khóa học");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(15, 15, 15)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jlbPosition, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jlbIDUser, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addComponent(jToolBar1, javax.swing.GroupLayout.DEFAULT_SIZE, 1103, Short.MAX_VALUE)
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(tableMainBoard)
                .addContainerGap())
        );
...
//    private void showFormDetailClass() {
//        if (formdetailclass != null) {
//            tableMainBoard.remove(menuMarkMJpanel);
//        }
//        try {
//            formdetailclass = new FormDetailClass();
//        } catch (Exception ex) {
//            Logger.getLogger(MainJFrame.class.getName()).log(Level.SEVERE, null, ex);
//        }
//        ImageIcon icon = new ImageIcon(getClass().getResource("/images/add16.png"));
//        tableMainBoard.addTab("Quản lí lớp HP ", icon, formdetailclass, "Quản lí lớp HP");
//        tableMainBoard.setSelectedComponent(formdetailclass);
//   }
    private void btn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn1ActionPerformed
        if ("Admin".equals(sharedData.userLogin.getPosition())) {
            jMenuSMActionPerformed(evt);
        } else if ("Giảng Viên".equals(sharedData.userLogin.getPosition()) || "Học Viên".equals(sharedData.userLogin.getPosition())) {
            jMenuItem5ActionPerformed(evt);
        }
    }//GEN-LAST:event_btn1ActionPerformed

    private void jMenuItem5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem5ActionPerformed
        // quan li lop hoc phan
        if (formdetailclass != null) {
            tableMainBoard.remove(formdetailclass);
        }
        try {
            formdetailclass = new FormDetailClass();
        } catch (Exception ex) {
        ...
        if ("Admin".equals(sharedData.userLogin.getPosition())) {
            ...
            tableMainBoard.addTab("Thông tin lớp HP ", icon, formdetailclass, "Thông tin lớp HP");
            tableMainBoard.setSelectedComponent(formdetailclass);
        }
